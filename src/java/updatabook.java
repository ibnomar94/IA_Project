 ...
 * @author ibnomar
 */
@WebServlet(urlPatterns = {"/updatabook"})
public class updatabook extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            sql = "UPDATE `book` SET `title`='"+title+"',`publishing_year`='"+pubyear+"',"
                    + "`author_name`='"+author+"',`isbn`='"+isbn+"',"                    
                    + "`added_by`='"+addedby+"' "
                    + "WHERE isbn ='"+isbn+"'";            
            int check  ;
            try {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(updatabook.class.getName()).log(Level.SEVERE, null, ex);
